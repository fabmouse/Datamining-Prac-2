...
tree <- rpart(LeaveRemain ~ Voting.1 + Voting.2 + Voting.3 + Voting.4 + 
                Voting.5 + Voting.6 + Voting.7 + Voting.8, data = dat, method = "class"
              , control = rpart.control(cp = 0.00001))#split: 0, 1, 4
printcp(tree)

tree <- rpart(LeaveRemain ~ Voting.1 + Voting.2 + Voting.3 + Voting.4 + 
                Voting.5 + Voting.6 + Voting.7 + Voting.8, data = dat, method = "class"
              , control = rpart.control(cp = 0.001))#split: 0, 1, 4
printcp(tree)

tree <- rpart(LeaveRemain ~ Voting.1 + Voting.2 + Voting.3 + Voting.4 + 
        Voting.5 + Voting.6 + Voting.7 + Voting.8, data = dat, method = "class"
        , control = rpart.control(cp = 0.1)) #split: 0, 1
printcp(tree)

tree <- rpart(LeaveRemain ~ Voting.1 + Voting.2 + Voting.3 + Voting.4 + 
                Voting.5 + Voting.6 + Voting.7 + Voting.8, data = dat, method = "class"
              , control = rpart.control(cp = 1)) #split: 0
printcp(tree)
